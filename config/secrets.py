...
username = "khitanshu4@gmail.com"       # Enter your username in the quotes
password = "Summmerof69!!"           # Enter your password in the quotes
...
llm_api_key = "AIzaSyDe17sZqh4vWjfjNY4ls1CaHmPn4daS1E8"              # Enter your API key in the quotes, make sure it's valid, if not will result in error.
'''
...
llm_model = "gemini-1.5-flash"          # Examples: "gpt-3.5-turbo", "gpt-4o", "llama-3.2-3b-instruct", "qwen3:latest", "gemini-pro", "gemini-1.5-flash", "gemini-2.5-flash", "deepseek-llm:latest"
